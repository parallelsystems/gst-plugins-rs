...
struct SessionInner {
    ...
    // The Datachannel, if it's part of the SDP
...
impl SessionInner {
    ...
    fn on_data_channel(&mut self, element: &super::BaseWebRTCSink, data_channel: glib::Object) {
        gst::info!(CAT, obj = element, "Adding data channel to session for {}", self.peer_id);
